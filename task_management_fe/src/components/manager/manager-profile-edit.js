...
function ManagerProfileEditUI() {
  ...
  useEffect(() => {
    ...
    fetch("http://127.0.0.1:8000/api/manager/profile/", {
  ...
  const updateProfile = async () => {
    ...
    const res = await fetch("http://127.0.0.1:8000/api/manager/profile/update/", {
      method: "POST",
      headers: { Authorization: `Bearer ${token}` },
      body: formData,
    });
...
export default ManagerProfileEditUI;
